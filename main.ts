input.onButtonPressed(Button.A, function () {
    basic.clearScreen()
    led.plot(2, 0)
    WiFiBit.executeHttpSMethod(
    HttpMethod.GET,
    HTTP_SERVER_NAME_THINGSPEAK,
    HTTPS_SERVER_PORT_THINGSPEAK,
...
input.onButtonPressed(Button.B, function () {
    ...
    WiFiBit.executeHttpMethod(
    HttpMethod.GET,
    HTTP_SERVER_PATH_FIELD1_APEX_ORACLE_COM,
    HTTPS_SERVER_PORT_APEX_ORACLE_COM,
    HTTP_SERVER_PATH_FIELD8_APEX_ORACLE_COM
    )
    led.plot(2, 1)
    led.plot(3, 0)
    led.plot(3, 1)
...
let HTTP_SERVER_PATH_FIELD1_APEX_ORACLE_COM = ""
let HTTPS_SERVER_PORT_APEX_ORACLE_COM = 0
...
let HTTPS_SERVER_PORT_THINGSPEAK = 0
...
let HTTP_SERVER_PORT_THINGSPEAK = 80
HTTPS_SERVER_PORT_THINGSPEAK = 443
...
let HTTP_SERVER_PATH_FIELD8_LOCAL_APEX = "/ords/f?p=106:6::application_process=log_data_01:::p6_field1,p6_field2,p6_field3,p6_field4,p6_field5,p6_field6,p6_field7,p6_field8:300030.0030003,600060.0060006,900090.0090009,1200120.0120012,1500150.0150015,1800180.0180018,2100210.0210021,2400240.0240024"
...
HTTPS_SERVER_PORT_APEX_ORACLE_COM = 443
HTTP_SERVER_PATH_FIELD1_APEX_ORACLE_COM = "/pls/apex/f?p=86511:6::application_process=log_data_01:::p6_field1:-99.9"
HTTP_SERVER_PATH_FIELD8_APEX_ORACLE_COM = "/pls/apex/f?p=86511:6::application_process=log_data_01:::p6_field1,p6_field2,p6_field3,p6_field4,p6_field5,p6_field6,p6_field7,p6_field8:300030.0030003,600060.0060006,900090.0090009,1200120.0120012,1500150.0150015,1800180.0180018,2100210.0210021,2400240.0240024"
